...
def container_detail(container_id):
    try:
        ...
        # Verificar que las imágenes existen y crear una lista de rutas válidas
        valid_images = []
        ...
        # Actualizar el contenedor con solo las imágenes válidas
        ...
        logger.error(f"Error en container_detail: {str(e)}")
